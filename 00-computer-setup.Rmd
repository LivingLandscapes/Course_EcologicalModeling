...
* Under *Installers* select **RStudio x.yy.zzz - Windows
  11 (or whatever number we're on now)** (where x, y, and z represent version numbers)
...
6. When you as satisfied, email Dr. Roberts the file. *You must also email any data or image files that are not generated by the R code.*


#### If you are new to git, but want to learn

1. Install Git on your computer using the instructions in the section below.
2. Follow the instructions on the [Git Intro tab](https://livinglandscapes.github.io/Course_EcologicalModeling/00-E-git-intro.html).


#### If you are familiar with git

1. If you have not aready done so, fork the repository from https://github.com/LivingLandscapes/Course_EcologicalModeling to your account on GitHub. Then clone a local copy of this forked repository (from your own GitHub account) to your computer. This only needs to be done once.
2. Before you start working:
    + Make sure your copy is up to date with the Ecological Modeling repository on GitHub by submitting a pull request.
...
6. Submit a pull request on GitHub to merge the changes on your fork with the original Ecological Modeling class repo.
