...
#the coefficient estimates are identical. Same with the standard error. 
#The bayesian gives us confidence intervals, while the lm gives us significance levels
#/ t values. So Bayesian does not give you a p value.
#Bayesian also gives you a sigma estimate, error, and confidence intervals. 
#It has no residuals either, whereas lm does have residuals and R^2.
#=============================================================================
## Model diagnostics
...
glm(WhistleCount _0.00001) -1, family = Gamma, data = whistle)